...
const myCampaigns = [
  ...
  {
    id: 2,
    title: "新オープン レストラン インスタ投稿",
    company: "SneakerWorld",
    ...
    progress: 60,
    messages: 2,
    image: "from-sky-300 to-blue-400",
  },
  {
    id: 3,
    title: "地方体験ツアー 動画レビュー",
    company: "FitLife App",
    status: "完了" as Status,
  ...
  {
    id: 4,
    title: "オーガニックカフェ SNS 企画",
    company: "GreenEats Japan",
    status: "進行中" as Status,
    statusColor: "bg-blue-100 text-blue-700",
    genre: "飲食店",
    area: "大阪",
    ...
    progress: 100,
    messages: 3,
    image: "from-lime-300 to-green-400",
  },
  {
    id: 5,
    title: "冒険ツアー TikTok PR",
    company: "TravelMate",
    status: "募集中" as Status,
    statusColor: "bg-amber-100 text-amber-700",
    genre: "体験＆ツアー",
  ...
  {
    id: 6,
    title: "グランピング体験 YouTube レビュー",
    company: "DeskSetup Pro",
    status: "募集中" as Status,
    statusColor: "bg-amber-100 text-amber-700",
    genre: "体験＆ツアー",
    area: "東京",
    ...
    progress: 33,
    messages: 0,
    image: "from-orange-300 to-amber-400",
  },
  {
    id: 7,
    title: "こだわり居酒屋 SNS キャンペーン",
    company: "PawLife Japan",
    status: "募集中" as Status,
    statusColor: "bg-amber-100 text-amber-700",
    genre: "飲食店",
    area: "名古屋",
...
export default function CampaignsPage() {
  ...
  useEffect(() => {
    setCampaigns(myCampaigns.map((c) => {
      ...
      return { ...c, status: saved, statusColor: colorMap[saved] ?? c.statusColor };
    }));
  }, []);
